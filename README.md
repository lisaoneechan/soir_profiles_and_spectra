...
```
git clone https://gitflic.ru/project/stepanova_es/soir-profiles-and-spectra.git
cd soir-profiles-and-spectra
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/stepanova_es/soir-profiles-and-spectra.git
git clone
